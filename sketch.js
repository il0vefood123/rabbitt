...
var emptyStar,star_1,star_2,starDisplay
...
function preload()
{
  ...
  star_1=loadImage("one_star.png")
  star_2=loadImage("stars.png")
...
function setup() 
{
  ...
  starDisplay.addAnimation("1",star_1)
  starDisplay.addAnimation("2",star_2)
...
function draw() 
{
  ...
  star.visible=false
  starDisplay.changeAnimation("1")
  }
  if(collide(fruit,star2,20)==true)
{
  star2.visible=false
  starDisplay.changeAnimation("2")
}
